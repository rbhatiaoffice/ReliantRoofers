...
export async function POST(request: NextRequest) {
  try {
    ...
    const adminEmail = process.env.ADMIN_EMAIL || 'rishi.bhatia.office@gmail.com';
...
If you have any urgent questions, please don't hesitate to call us on +44 7552 386343.
